...
\hypersetup{
  pdftitle={A FAIR Evidence Object Layer for Auditable Agent Self-Improvement: From Agent Traces to Verifiable Evidence Packages},
  pdfauthor={Zhang Bin},
  pdfsubject={Agent self-improvement evidence, provenance, FAIR evidence objects, reproducibility},
  pdfkeywords={agent self-improvement, evidence objects, provenance, FAIR, reproducibility, research objects}
}
...
\begin{IEEEkeywords}
agent self-improvement, evidence objects, provenance, FAIR, reproducibility, research objects
\end{IEEEkeywords}
